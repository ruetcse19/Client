(function($){
    ...
    function mainMap() {
      ...
      function locationData(jobURL, companyLogo, companyName, jobTitle, verifiedBadge) {
          return(''+
            '<a href="'+jobURL+'" class="resource-listing">'+
               '<div class="infoBox-close"><i class="icon-feather-x"></i></div>'+
               '<div class="resource-listing-details">'+
                  '<div class="resource-listing-company-logo">'+
                    '<div class="'+verifiedBadge+'-badge"></div>'+
                    '<img src="'+companyLogo+'" alt="">'+
                  '</div>'+
                  '<div class="resource-listing-description">'+
                    '<h4 class="resource-listing-company">'+companyName+'</h4>'+
                    '<h3 class="resource-listing-title">'+jobTitle+'</h3>'+
                  '</div>'+
               '</div>'+
            '</a>')
      }
